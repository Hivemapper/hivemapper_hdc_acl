...
const signatureB58 = `5rpg6m3ceLQmzWU6zeNE1y8vdNLQgFpFoTjmaoh39vMfhqF83D9Tn1b6hTxoU1Li2tnvB9N3ucP8WQ7AonxZDFM8`
...
func Test_messageToSign(t *testing.T) {
	...
	message, err := acl.messageToSign()
	require.NoError(t, err)

	require.Equal(t, "Lock Camera with Access Control List with 1 manager(s) and 55 driver(s). Hash: 492238a930883b0dd6ed791dc1e0152a", string(message))
}
